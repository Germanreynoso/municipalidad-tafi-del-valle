...
export const searchIndex = [
  ...
  ...actividades.map(act => ({
    title: act.id === 'yungasadventure' ? 'EVT Yungas Adventure and Travel (La Cumbre)' : act.id, // Simplificación para demo, lo ideal es usar i18n aquí pero searchIndex es estático
