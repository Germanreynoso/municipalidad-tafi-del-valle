        ...
        <>
          ...
          >
            <div className="bg-white rounded-3xl overflow-hidden max-w-2xl w-full max-h-[90vh] shadow-2xl pointer-events-auto flex flex-col">
              ...
              {/* Scrollable Content */}
              <div className="p-6 overflow-y-auto font-body text-stone-700 space-y-6">
                ...
                {!attraccion.descripcionLarga && (
                   <p className="italic text-stone-400">Próximamente más información detallada sobre este sitio.</p>
                )}
              </div>
